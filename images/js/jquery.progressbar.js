	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage	: '/uvpanel/images/progressbar.gif',		// boxImage : image around the progress bar
				barImage	: '/uvpanel/images/progressbg_green.gif',	// Image to use in the progressbar. Can be an array of images too.
